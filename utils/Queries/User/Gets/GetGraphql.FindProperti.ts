...
export async function getGraphqlFindProperti(id: number) {
    const headers = {
        ...
        const requestBody = {
            query: `query FindPropertyUser($findPropertyUserId: Float!) {
                findPropertyUser(id: $findPropertyUserId) {
                  fullName
                  userName
                  foto
                }
