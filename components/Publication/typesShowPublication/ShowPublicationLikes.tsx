...
const ShowPublicationLikes = (props: Props) => {
    const [publications, setPublications] = useState<[]>();
    const [renderData, setRenderData] = useState(false);
    const {profile} = props;

    const getAllPublication = async () => {
        const response = await QueryPublication.findAllPublicationByLike(profile);
        ...
        setPublications(response['data']['publicationAllLikes']);
    };
...
export default ShowPublicationLikes