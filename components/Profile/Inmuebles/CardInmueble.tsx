...
const CardInmueble = (props: Props) => {
    const {tipoChecked} = props;
  return (
    <div className=''>
        <Card
                    horizontal={true}
                ...
                >
                    <a href="#">
                        <h5 className="text-base font-semibold text-gray-900 dark:text-white">
                            Se vende departamento en el centro de la ciudad
                        </h5>
                    </a>
                    ...
                    <div className="flex flex-row items-center justify-between">
                        <span className="sm:text-base text-xl font-bold text-gray-900 dark:text-white">
                            $599
                        </span>
                        <div className='flex flex-row'>
                            <Image
                                ...
                                className='mr-2'
                            />
                            <div className='flex justify-center align-middle m-auto  text-gray-900 dark:text-white font-bold'>
                            <p className='text-sm'>Inmueble activo</p>
                            </div>
                        </div>
